...
local mob_pop = {
  ...
  [1] = {
    ...
    ['big-biter'] = {chance = 0.2, count = 3},
    ['big-spitter'] = {chance = 0.1, count = 3},
  },
  [2] = {
    ['small-biter'] = {chance = 0.2, count = 80},
    ['medium-biter'] = {chance = 0.4, count = 20},
    ['big-biter'] = {chance = 0.3, count = 4},
    ['behemoth-biter'] = {chance = 0.1, count = 2},
    ['small-spitter'] = {chance = 0.2, count = 40},
    ['medium-spitter'] = {chance = 0.4, count = 20},
    ['big-spitter'] = {chance = 0.2, count = 4},
    ['behemoth-spitter'] = {chance = 0.1, count = 2},
  },
  [3] = {
    ['small-biter'] = {chance = 0.15, count = 100},
    ['medium-biter'] = {chance = 0.25, count = 50},
    ['big-biter'] = {chance = 0.35, count = 8},
    ['behemoth-biter'] = {chance = 0.2, count = 3},
    ['small-spitter'] = {chance = 0.15, count = 50},
    ['medium-spitter'] = {chance = 0.25, count = 40},
    ['big-spitter'] = {chance = 0.25, count = 8},
    ['behemoth-spitter'] = {chance = 0.15, count = 3},
  },
  [4] = {
    ['medium-biter'] = {chance = 0.2, count = 80},
    ['big-biter'] = {chance = 0.55, count = 15},
    ['behemoth-biter'] = {chance = 0.4, count = 6},
    ['medium-spitter'] = {chance = 0.2, count = 60},
    ['big-spitter'] = {chance = 0.55, count = 10},
    ['behemoth-spitter'] = {chance = 0.4, count = 6},
  },
  [5] = {
    ['medium-biter'] = {chance = 0.3, count = 100},
    ['big-biter'] = {chance = 0.6, count = 25},
    ['behemoth-biter'] = {chance = 0.5, count = 9},
    ['medium-spitter'] = {chance = 0.3, count = 70},
    ['big-spitter'] = {chance = 0.6, count = 15},
    ['behemoth-spitter'] = {chance = 0.5, count = 9},
  },
  [6] = {
