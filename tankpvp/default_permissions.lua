...
local default_group = function(id)
  ...
  pgroup.set_allows_action(defines.input_action.open_tutorials_gui, false)
  ...
  pgroup.set_allows_action(defines.input_action.create_blueprint_like, false)
  pgroup.set_allows_action(defines.input_action.copy_opened_blueprint, false)
  pgroup.set_allows_action(defines.input_action.change_blueprint_library_tab, false)
