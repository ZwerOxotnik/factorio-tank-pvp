...
Gui.on_gui_checked_state_changed = function(event)
  ...
  if element == PDB.guis.ffa_frame.tready then
    PDB.queueing_for_team_game = element.state
  end
end
...
Gui.on_gui_click = function(event)
  ...
  if element == PDB.guis.tspec_frame.tspecbtn then
    Game_var.go_spectate_teamgame(player)
  elseif element == PDB.guis.tspec_ing_frame.quitbtn then
    Game_var.go_return_ffagame(player)
  elseif element == PDB.guis.stat_view_btn then
  ...
  elseif element == PDB.guis.tdmstat_frame.header.closebtn then
...
Gui.on_gui_closed = function(event)
  ...
  if element == PDB.guis.tdmstat_frame then
    PDB.guis.tdmstat_frame.visible = false
  end
end
